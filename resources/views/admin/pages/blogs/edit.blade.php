                ...
                <div class="col-lg-6">
                    <div class="card px-2 py-2">
                        <div class="mb-3">
                            ...
                            <input type="text" id="blog_name" name="blog_name" class="form-control" value="{{ $blog->blog_name }}" placeholder="Blog Name">
                ...
                <div class="col-lg-6">
                    <div class="card px-2 py-2">
                        <div class="mb-3">
                            ...
                            <input type="text" id="slug" name="slug" class="form-control" value="{{ $blog->slug }}" placeholder="Blog Slug">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" id="quill_html" name="description" value="{{ $blog->description }}"></input>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-9">
                                                                   <textarea name="meta_description" id="" class="form-control">{{ $blog->meta_description }}</textarea>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="file" id="meta_image" name="meta_image" value="{{ $blog->meta_image }}" class="form-control">
                ...
                <div class="card-body">
                    ...
                    <div class="category_list_box border px-2 py-2">
                        <select name="blog_categories[]" id="blog_categories" class="form-control" multiple>
                            ...
                            <option value="{{ $category->id }}" {{ $blog->categories->contains($category->id) ? 'selected' : '' }}>
             ...
             <div class="card">
              <div class="card-body">
                 ...
                 <div class="product_image border mb-2 text-center">
                    <img src="{{ asset('photos/image/' . $blog->image) }}" alt="{{ $blog->blog_alt }}" width="200px">
                </div>
                  <div class="product_image border p-2">
                    <input type="file" id="image" name="image" class="form-control" value="{{ $blog->image }}">
                 ...
                 <div class="product_image border p-2">
                   <input type="text" id="alt" name="blog_alt" class="form-control" value="{{ $blog->blog_alt }}">
