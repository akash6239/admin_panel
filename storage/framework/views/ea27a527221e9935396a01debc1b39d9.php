...
<!-- ....................................................... -->
    <!-- <link href="<?php echo e(asset('backend/assets/libs/dropzone/min/dropzone.min.css')); ?>" rel="stylesheet" type="text/css" /> -->
    <!-- <link href="<?php echo e(asset('backend/assets/libs/dropify/css/dropify.min.css')); ?>" rel="stylesheet" type="text/css" /> -->
    <!-- Theme Config Js -->
    <?php echo $__env->yieldPushContent('css'); ?>
    <script src="<?php echo e(asset('backend/assets/js/head.js')); ?>"></script>
    <!-- Bootstrap css -->
    <link href="<?php echo e(asset('backend/assets/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css" id="app-style" />
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="app-menu">
            ...
            <div class="logo-box border-bottom">
                <!-- Brand Logo Light -->
                <a href="<?php echo e(route('index')); ?>" class="logo-light" target="_blank">
                    <img src="<?php echo e(asset('backend/assets/images/logo-light.png')); ?>" alt="logo" class="logo-lg">
                    <img src="<?php echo e(asset('backend/assets/images/logo-sm.png')); ?>" alt="small logo" class="logo-sm">
                </a>

                <!-- Brand Logo Dark -->
                <a href="<?php echo e(route('index')); ?>" class="logo-dark" target="_blank">
                    <img src="<?php echo e(asset('backend/assets/images/logo-dark.jpeg')); ?>" alt="dark logo" class="logo-lg" style="width:170px; height:50px">
                    <img src="<?php echo e(asset('backend/assets/images/logo-sm.png')); ?>" alt="small logo" class="logo-sm">
                </a>
            </div>
            ...
            <div class="scrollbar">
                ...
                <ul class="menu">
                    ...
                    <li class="menu-item">
                        <a href="<?php echo e(route('media')); ?>"  class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuProjects">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="<?php echo e(route('productview')); ?>" class="menu-link">
                                        <span class="menu-text">View Products</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="<?php echo e(route('product')); ?>" class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuTasks">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="<?php echo e(route('blogview')); ?>" class="menu-link">
                                        <span class="menu-text">View Blogs</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="<?php echo e(route('blogs')); ?>" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="<?php echo e(route('enquiry')); ?>"  class="menu-link">
                            <span class="menu-icon"><i class="mdi mdi-cart-outline"></i></span>
                    ...
                    <ul class="topbar-menu d-flex align-items-center">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                                ...
                                <!-- item-->
                                <a href="<?php echo e(route('adminlogout')); ?>" class="dropdown-item notify-item">
    ...
    <script src="<?php echo e(asset('backend/assets/libs/jquery.scrollto/jquery.scrollTo.min.js')); ?>"></script>
   
    
</body>
<?php echo \Livewire\Mechanisms\FrontendAssets\FrontendAssets::scripts(); ?>

</html><?php /**PATH E:\html code\New folder\rednirus_cms\resources\views\admin\layout\sidebar.blade.php ENDPATH**/ ?>