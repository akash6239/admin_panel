                ...
                <div class="col-lg-6">
                    <div class="card px-2 py-2">
                        <div class="mb-3">
                            ...
                            <input type="text" id="blog_name" name="blog_name" class="form-control" value="<?php echo e($blog->blog_name); ?>" placeholder="Blog Name">
                ...
                <div class="col-lg-6">
                    <div class="card px-2 py-2">
                        <div class="mb-3">
                            ...
                            <input type="text" id="slug" name="slug" class="form-control" value="<?php echo e($blog->slug); ?>" placeholder="Blog Slug">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" id="quill_html" name="description" value="<?php echo e($blog->description); ?>"></input>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" id="meta_title" name="meta_title" class="form-control" value="<?php echo e($blog->meta_title); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" id="meta_keywords" name="meta_keywords" value="<?php echo e($blog->meta_keywords); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-9">
                                                                   <textarea name="meta_description" id="" class="form-control"><?php echo e($blog->meta_description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="file" id="meta_image" name="meta_image" value="<?php echo e($blog->meta_image); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-lg-3">
                ...
                <div class="card-body">
                    ...
                    <div class="category_list_box border px-2 py-2">
                        <select name="blog_categories[]" id="blog_categories" class="form-control" multiple>
                            ...
                            <option value="<?php echo e($category->id); ?>" <?php echo e($blog->categories->contains($category->id) ? 'selected' : ''); ?>>
            ...
            <!-- ....................................... -->
             ...
             <div class="card">
              <div class="card-body">
                 <h5 class="border-bottom pb-1">Edit Blog Image</h5>
                 <div class="product_image border mb-2 text-center">
                    <img src="<?php echo e(asset('photos/image/' . $blog->image)); ?>" alt="<?php echo e($blog->blog_alt); ?>" width="200px">
                </div>
                  <div class="product_image border p-2">
                    <input type="file" id="image" name="image" class="form-control" value="<?php echo e($blog->image); ?>">
...
unset($__errorArgs, $__bag); ?>
                 ...
                 <div class="product_image border p-2">
                   <input type="text" id="alt" name="blog_alt" class="form-control" value="<?php echo e($blog->blog_alt); ?>">
...
<?php echo $__env->make('admin.layout.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\html code\New folder\rednirus_cms\resources\views/admin/pages/blogs/edit.blade.php ENDPATH**/ ?>